...
qqPlot(model_diag_model_4$.stdresid, main = 'Q-Q График', ylab = 'Стандр. отстатки', xlab = 'Кванитили')
```
...
```{r}
qqPlot(model_disp, id = FALSE, main = 'Q-Q График', ylab = 'Стандр. отстатки', xlab = 'Кванитили')
